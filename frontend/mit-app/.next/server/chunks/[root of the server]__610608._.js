...
"[externals]/ [external] (sqlite3, cjs)": (function(__turbopack_context__) {

var { r: __turbopack_require__, f: __turbopack_module_context__, i: __turbopack_import__, s: __turbopack_esm__, v: __turbopack_export_value__, n: __turbopack_export_namespace__, c: __turbopack_cache__, M: __turbopack_modules__, l: __turbopack_load__, j: __turbopack_dynamic__, P: __turbopack_resolve_absolute_path__, U: __turbopack_relative_url__, R: __turbopack_resolve_module_id_path__, b: __turbopack_worker_blob_url__, g: global, __dirname, x: __turbopack_external_require__, y: __turbopack_external_import__, m: module, e: exports, t: require } = __turbopack_context__;
{
const mod = __turbopack_external_require__("sqlite3");
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$sqlite3$2c$__cjs$29$__ = __turbopack_import__("[externals]/ [external] (sqlite3, cjs)");
;
const DATABASE_PATH = './database/db.sqlite';
const db = new __TURBOPACK__imported__module__$5b$externals$5d2f$__$5b$external$5d$__$28$sqlite3$2c$__cjs$29$__["default"].Database(DATABASE_PATH, (err)=>{
    if (err) {
...
"[project]/src/app/api/wikis/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        // 特定のIDのwikiを取得
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])('SELECT * FROM wiki WHERE id = ?', [
            id
        ]);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Failed to fetch wiki entry.'
        }, {
            status: 500
        });
    }
...
async function PUT(request, { params }) {
    ...
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])('UPDATE wiki SET title = ?, content = ? WHERE id = ?', [
            title,
            content,
            id
        ]);
        ...
        if (!result) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Wiki entry not found or no changes made.'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__610608._.js.map