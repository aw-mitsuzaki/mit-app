...
async function DELETE(req, { params }) {
    ...
    try {
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])('DELETE FROM diary WHERE id = ?', [
            id
        ]);
        // 削除が成功したかチェック
        if (result.affectedRows === 0) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__270160._.js.map