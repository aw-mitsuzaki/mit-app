...
"[project]/src/lib/db.ts [app-route] (ecmascript)": (() => {{

throw new Error("An error occurred while generating the chunk item [project]/src/lib/db.ts [app-route] (ecmascript)\n\nCaused by:\n- failed to parse [project]/src/lib/db.ts\n- Cell doesn't exist\n\nDebug info:\n- An error occurred while generating the chunk item [project]/src/lib/db.ts [app-route] (ecmascript)\n- Execution of *EcmascriptChunkItemContent::module_factory failed\n- Execution of *EcmascriptChunkItemContent::new failed\n- Execution of <EcmascriptModuleAsset as EcmascriptAnalyzable>::module_content failed\n- Execution of parse failed\n- failed to parse [project]/src/lib/db.ts\n- Cell doesn't exist");

}}),
"[project]/src/app/api/diaries/route.ts [app-route] (ecmascript)": (() => {{

throw new Error("An error occurred while generating the chunk item [project]/src/app/api/diaries/route.ts [app-route] (ecmascript)\n\nCaused by:\n- failed to parse [project]/src/app/api/diaries/route.ts\n- Cell doesn't exist\n\nDebug info:\n- An error occurred while generating the chunk item [project]/src/app/api/diaries/route.ts [app-route] (ecmascript)\n- Execution of *EcmascriptChunkItemContent::module_factory failed\n- Execution of *EcmascriptChunkItemContent::new failed\n- Execution of <EcmascriptModuleAsset as EcmascriptAnalyzable>::module_content failed\n- Execution of parse failed\n- failed to parse [project]/src/app/api/diaries/route.ts\n- Cell doesn't exist");
