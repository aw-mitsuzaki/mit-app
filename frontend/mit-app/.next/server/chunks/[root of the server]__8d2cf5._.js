...
"[project]/src/app/api/passwords/[id]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    ...
    try {
        // 特定のIDの日記を取得
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["runQuery"])('SELECT * FROM password_manager WHERE id = ?', [
            id
        ]);
...
async function PUT(request, { params }) {
    ...
    try {
        ...
        if (!result) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'password_manager entry not found or no changes made.'
            }, {
                status: 404
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8d2cf5._.js.map